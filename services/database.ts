...
export const INITIAL_COMPANIONS: Companion[] = [
  { id: 'c1', name: 'Ruby', specialty: 'Anxiety & Panic', status: 'AVAILABLE', rating: 4.9, imageUrl: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=600&h=600', bio: 'Specializing in grounding techniques and immediate stress relief.', replicaId: 're3a705cf66a' },
  { id: 'c2', name: 'Carter', specialty: 'Life Coaching', status: 'AVAILABLE', rating: 4.8, imageUrl: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&q=80&w=600&h=600', bio: 'Helping you build a roadmap for personal success.', replicaId: 'rca8a38779a8' },
  { id: 'c3', name: 'James', specialty: 'Men\'s Health', status: 'AVAILABLE', rating: 4.9, imageUrl: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&q=80&w=600&h=600', bio: 'A safe space to discuss pressure, expectations, and balance.', replicaId: 'r92debe21318' },
  { id: 'c4', name: 'Danny', specialty: 'Grief Support', status: 'AVAILABLE', rating: 5.0, imageUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=600&h=600', bio: 'Walking beside you through times of loss.', replicaId: 'r62baeccd777' },
  { id: 'c5', name: 'Anna', specialty: 'Family Dynamics', status: 'AVAILABLE', rating: 4.9, imageUrl: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&q=80&w=600&h=600', bio: 'Navigating complex family relationships with care.', replicaId: 'r6ae5b6efc9d' },
  { id: 'c28', name: 'Elena', specialty: 'Women\'s Health', status: 'AVAILABLE', rating: 5.0, imageUrl: 'https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?auto=format&fit=crop&q=80&w=600&h=600', bio: 'Holistic support for hormonal health, fertility, and menopause.', replicaId: 'r86e2c395e725' }, 
  { id: 'c7', name: 'Olivia', specialty: 'Workplace Stress', status: 'AVAILABLE', rating: 4.9, imageUrl: 'https://images.unsplash.com/photo-1598550874175-4d7112ee7f41?auto=format&fit=crop&q=80&w=600&h=600', bio: 'Strategies to handle burnout and professional anxiety.', replicaId: 'rc2146c13e81' },
  { id: 'c8', name: 'Charlie', specialty: 'General Listening', status: 'AVAILABLE', rating: 4.8, imageUrl: 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?auto=format&fit=crop&q=80&w=600&h=600', bio: 'Here to listen to whatever is on your mind.', replicaId: 'rf4703150052' },
  { id: 'c9', name: 'Luna', specialty: 'Creative Blocks', status: 'AVAILABLE', rating: 4.9, imageUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=600&h=600', bio: 'Unlocking your potential through open dialogue.', replicaId: 're5c4a8dd5ea' },
